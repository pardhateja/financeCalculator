...
RP._tabGroups = {
    ...
    'retire-today': { label: 'Retire Today', tabs: ['retire-today', 'retire-today-mg', 'retire-today-delay', 'retire-today-delay-mg'] },
...
RP._tabLabels = {
    ...
    'retire-today-delay': 'Delay (live corpus)',
    'retire-today-delay-mg': 'Delay (Multi-Goal)',
    'profiles': 'Profiles'
};
