    ...
    <div class="container">
        <header style="position:relative;">
            ...
            <div style="position:absolute;top:20px;right:20px;display:flex;gap:8px;">
                ...
                <label for="includePhasesInShareLink" style="display:flex;align-items:center;gap:6px;background:rgba(0,0,0,0.35);color:#fff;border:2px solid rgba(255,255,255,0.5);padding:8px 12px;border-radius:8px;font-size:0.85rem;font-weight:600;backdrop-filter:blur(10px);cursor:pointer;user-select:none;"><input type="checkbox" id="includePhasesInShareLink" checked style="margin:0;cursor:pointer;">Include phases</label>
